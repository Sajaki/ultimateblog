...
class category
{
	...
	*/
	...
	function display($cat_id)
	{
		...
		//Start pagination
		$this->pagination->generate_template_pagination($this->helper->route('posey_ultimateblog_category', array('cat_id' => $cat_id)), 'pagination', 'start', $total_catergory_blogs, $this->config['ub_latest_blogs'], $start);
